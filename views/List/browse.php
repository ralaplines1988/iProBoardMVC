    ...
    <main class="main">
        ...
        <div class="page-info clearfix">
            ...
            <div class="page-nav">
                ...
                <a href="/mvc/list/browse/1">FirstPage</a> | <a href="/mvc/list/browse/<?php echo $data->num_pages-1;?>">PrevPage</a>
                <?php }?>
                <?php if ($data->num_pages < $data->total_pages) {?>
                <a href="/mvc/list/browse/<?php echo $data->num_pages+1;?>">NextPage</a> | <a
                    href="/mvc/list/browse/<?php echo $data->total_pages;?>">LastPage</a>
                <?php }?>
            </div>
        </div>
    </main>
